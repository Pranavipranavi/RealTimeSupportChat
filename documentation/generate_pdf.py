    ...
    while idx < len(lines):
        ...
        if line.startswith("# "):
            ...
            if title.startswith("Internship Project Report"):
                ...
                html_lines.append("    <div class='cover-details-row'><span class='cover-details-label'>Intern Name:</span><span class='cover-details-value'>Sai Pranavi</span></div>")
                html_lines.append("    <div class='cover-details-row'><span class='cover-details-label'>Intern ID:</span><span class='cover-details-value'>CITS1983</span></div>")
